...
class TypesafeClientTest {
    ...
    @Test
    void serializesEachQuestionTypeWithItsDiscriminator() throws Exception {
    ...
    @Test
    void deserializesEachAnswerTypeFromItsDiscriminator() throws Exception {
        String json = """
                {
                  "model": "jev-latest",
                  "answers": {
        ...
        EvaluateResponse response = mapper.readValue(json, EvaluateResponse.class);
