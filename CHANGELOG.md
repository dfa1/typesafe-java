...
- `Model` enum (`LATEST`, `PREVIEW`, `JEV_1_13_0`) per [docs.typesafe.ai/models](https://docs.typesafe.ai/models), plus `EvaluateRequest.of(state, Model, questions)` to pick one explicitly.
